        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    Tambah Kriteria Tenaga Kerja
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Tambah Kriteria Tenaga Kerja</span></div>
                <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/tenagakerja/tambah`, this.form)
                if(res.status == 200) {
