        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    Tambah Kriteria Deadline Hari
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Tambah Kriteria Deadline Hari</span></div>
                <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/deadlinehari/tambah`, this.form)
                if(res.status == 200) {
