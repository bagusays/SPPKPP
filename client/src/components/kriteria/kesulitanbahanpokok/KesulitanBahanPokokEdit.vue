...
<div>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li style="font-size: 15px;" class="breadcrumb-item"> <router-link to="/kriteria/kebawelanpelanggan">List Kriteria Kesulitan Bahan Pokok</router-link>
                </li>
            ...
            <div class="card">
                <div class="card-header"><span>Edit Kriteria Kesulitan Bahan Pokok</span></div>
                <div class="card-body">
    ...
    methods: {
        ...
        async getDetail() {
            try {
                ...
                let result = await this.$helpers.axiosAuth.post(`/kriteria/kesulitanbahanpokok/detail`, param)
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/kesulitanbahanpokok/edit`, this.form)
                if(res.status == 200) {
