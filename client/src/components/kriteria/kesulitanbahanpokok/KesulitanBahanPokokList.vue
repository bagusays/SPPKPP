...
<div>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li style="font-size: 15px;" class="breadcrumb-item active">Kriteria Kesulitan Bahan Pokok</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-right">
								<router-link to="/kriteria/kesulitanbahanpokok/tambah" class="btn btn-sm button-action btn-tambah">
                                    ...
                                    <tbody>
                                        <tr v-for="data in data" :key="data.Id">
                                            ...
                                            <td class="text-center">
                                                <router-link :to="'/kriteria/kesulitanbahanpokok/edit/' + data.Id">
...
export default {
    ...
    methods: {
        ...
        async getList() {
            const result = await this.$helpers.axiosAuth.get(`/kriteria/kesulitanbahanpokok/list`);
        ...
        async onDelete(Id) {
            ...
            const res = await this.$helpers.axiosAuth.post(`/kriteria/kesulitanbahanpokok/delete`, {Id})
            if(res.status == 200) {
