...
<div>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li style="font-size: 15px;" class="breadcrumb-item"> <router-link to="/kriteria/kebawelanpelanggan">List Kriteria Kebawelan Pelanggan</router-link>
                </li>
                <li class="breadcrumb-item active">
                    Edit Kriteria Kebawelan Pelanggan
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Edit Kriteria Kebawelan Pelanggan</span></div>
                <div class="card-body">
    ...
    methods: {
        ...
        async getDetail() {
            try {
                ...
                let result = await this.$helpers.axiosAuth.post(`/kriteria/kebawelanpelanggan/detail`, param)
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/kebawelanpelanggan/edit`, this.form)
                if(res.status == 200) {
                    await this.$helpers.alert.success(res.data.message)
                    this.$router.push({ path: '/kriteria/kebawelanpelanggan' })
                } else
