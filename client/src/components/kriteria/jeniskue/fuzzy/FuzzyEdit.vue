...
<div>
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                <li style="font-size: 15px;" class="breadcrumb-item"> <router-link to="/kriteria/jeniskue">List Kriteria Fuzzy Jenis Kue</router-link>
                </li>
                <li class="breadcrumb-item active">
                    Edit Kriteria Fuzzy Jenis Kue
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Edit Kriteria Fuzzy Jenis Kue</span></div>
                <div class="card-body">
    ...
    methods: {
        ...
        async getDetail() {
            try {
                ...
                let result = await this.$helpers.axiosAuth.post(`/kriteria/jeniskue/fuzzy/detail`, param)
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/jeniskue/fuzzy/edit`, this.form)
                if(res.status == 200) {
