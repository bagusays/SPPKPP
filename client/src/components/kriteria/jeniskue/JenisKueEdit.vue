        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    Edit Kriteria Jenis Kue
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Edit Kriteria Jenis Kue</span></div>
                <div class="card-body">
    ...
    methods: {
        ...
        async getDetail() {
            try {
                ...
                let result = await this.$helpers.axiosAuth.post(`/kriteria/jeniskue/detail`, param)
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/jeniskue/edit`, this.form)
                if(res.status == 200) {
