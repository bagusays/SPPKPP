        ...
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    Tambah Kriteria Jarak Pengiriman
                </li>
            </ol>
            <div class="card">
                <div class="card-header"><span>Tambah Kriteria Jarak Pengiriman</span></div>
                <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            if(validate) {
                let res = await this.$helpers.axiosAuth.post(`/kriteria/jarakpengiriman/tambah`, this.form)
                if(res.status == 200) {
